    ...
    def test_project_assignment_stores_only_alias_metadata(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                os.environ["TEST_REAL_DATABASE_URL"] = "postgres://real:secret@db.example.com/app"
                ...
                self.assertNotIn("postgres://real", json.dumps(raw))
                ...
                self.assertEqual(
                    "postgres://real:secret@db.example.com/app",
